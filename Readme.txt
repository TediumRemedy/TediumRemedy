...
You can switch mode - "Regular conversaion", "Asking Questions (Spying)", "Answering Questions", by pressing Ctrl+Z (then the new mode kicks in after you press Esc). There's a mode indicator in the status bar.
